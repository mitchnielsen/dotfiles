...
- **Budget ceiling and price sensitivity**: I'm generally happy to pay
  more for quality, longevity, better warranty, or better support — but
...
financial products. Include site-specific searches like
`site:reddit.com`, `site:youtube.com`, and category forums, alongside
general web search.
...
YouTube vs. blogs) it's fine to parallelize research — e.g. via forked
subagents per source category — to keep this thread's context focused
on synthesis rather than raw search output.
...
instead of/in addition to the chat summary — don't build the artifact
unprompted.
