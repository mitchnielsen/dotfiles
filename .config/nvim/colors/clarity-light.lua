-- clarity-light.lua — minimal light colorscheme for legibility
...
--   interp (#0550ae) — string interpolation delimiters `${...}`
--   muted  (#6e7781) — comments, dim UI, deemphasized text

vim.cmd("highlight clear")
vim.g.colors_name = "clarity-light"
...
local c = {
  ...
  yellow = "#8a5a00",
  param = "#6f5e2e",
  interp = "#0550ae", -- string interpolation: `${VAR}` delimiters
  visual = "#d8dee4",
  cursor_line = "#eaeef2",
  search = "#fbe5a0",
  match = "#eaeef2",
...
hi("FzfLuaCursorLine", { bg = "#b6e3ff" })
hi("FzfLuaCursorLineNr", { fg = c.fg, bg = "#b6e3ff", bold = true })
